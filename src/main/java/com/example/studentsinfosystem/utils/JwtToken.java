...
//
//    public String jwt(ManagerCreated managerCreated){
...
//                //payload,里面会有一些主要内容
//                .claim("username", managerCreated.getUsername())//设置username
//                .claim("role", managerCreated.getRole())//设置role
...
//    }
//
//    public String jwt(StudentLogin studentLogin){
//        //Token组成三部分,header,payload,signature
//        String Token = Jwts.builder()
//                //header
//                .setHeaderParam("typ", "JWT")
//                //.setHeaderParam("alg","HS256"),默认的算法签名,可以不写
//                //payload,里面会有一些主要内容
//                .claim("studentId", studentLogin.getStudentId())//设置studentId
//                .claim("role", studentLogin.getRole())//设置role
//                .setExpiration(new Date(System.currentTimeMillis() + time))//设置到期时间
//                .setIssuedAt(new Date(System.currentTimeMillis()))//创建时间
//                //signature
//                .signWith(SignatureAlgorithm.HS256, signature)//算法加密,唯一性的特征
